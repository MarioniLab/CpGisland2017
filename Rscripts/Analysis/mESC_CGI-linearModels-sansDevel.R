...
devel_genes <- read.table("~/Dropbox/Genesets/GO_development-mouse.tsv",
...
write.table(mesc.rlm.df,
            file="~/Dropbox/Noise_genomics/Model_results/mouse_ESC_CGI-univariateRLM-sansDevel.tsv",
...
ggsave(cpg.plot,
       filename="~/Dropbox/Noise_genomics/Figures/ms_figures/mESC_CGI-univariateLM-sansDevel.png",
...
write.table(mesc.rlm.res,
            file="~/Dropbox/Noise_genomics/Model_results/mouse_ESC_CGI-multivariateRLM-sansDevel.tsv",
            quote=FALSE, row.names=FALSE, sep="\t")
...
ggsave(all.plot,
       filename="~/Dropbox/Noise_genomics/Figures/ms_figures/mESC_CGI-allLM-sansDevel.png",
