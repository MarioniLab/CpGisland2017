...
source("~/Dropbox/R_sessions/Noise/human_beta_islet_genomic_noise_features-alt_data.R")
library(scales)
library(ggplot2)
library(robustbase)
...
beta.vars <- beta.vars[grepl(beta.vars, pattern="(CGI_SIZE.kb)|(SP1)")]
...
write.table(beta.rlm.df,
            file="~/Dropbox/Noise_genomics/Model_results/human_BetaIslet_CGI-alt_data-univariateRLM.tsv",
...
ggsave(cpg.plot,
       filename="~/Dropbox/Noise_genomics/Figures/ms_figures/human-BetaIslet_CGI-alt_data-univariateLM.png",
...
write.table(beta.rlm.res,
            file="~/Dropbox/Noise_genomics/Model_results/human_BetaIslet_CGI-alt_data-multivariateRLM.tsv",
            sep="\t", quote=FALSE, row.names=FALSE)
...
ggsave(cpg.plot,
       filename="~/Dropbox/Noise_genomics/Figures/ms_figures/human-BetaIslet_CGI-alt_data-multiivariateLM.png",
       height=5.25, width=11.75, dpi=300)
...
ggsave(all.plot,
       filename="~/Dropbox/Noise_genomics/Figures/ms_figures/human-BetaIslet_CGI-alt_data-allLM.png",
