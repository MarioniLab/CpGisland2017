...
write.table(panc.rlm.res,
            file="~/Dropbox/Noise_genomics/Model_results/human_AlphaIslet_multivariateRLM.tsv",
...
ggsave(tc_cpg,
       filename="~/Dropbox/Noise_genomics/Figures/ms_figures/human-AlphaIslet_boxplot_CpGislands-overdispersion.png",
...
ggsave(tc_cpgMe,
       filename="~/Dropbox/Noise_genomics/Figures/ms_figures/human-AlphaIslet_boxplot_CpGislands-mean.png",
       height=3.75, width=4.75, dpi=300)