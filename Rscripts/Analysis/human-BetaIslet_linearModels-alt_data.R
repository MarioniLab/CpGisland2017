...
ggsave(univar.plot,
       filename="~/Dropbox/Noise_genomics/Figures/ms_figures/human-BetaIslet-alt_data-univariateLM.png",
...
ggsave(multivar.plot,
       filename="~/Dropbox/Noise_genomics/Figures/ms_figures/human-BetaIslet-alt_data-multiivariateLM.png",
       height=4.75, width=6.75, dpi=300)
...
ggsave(all.plot,
       filename="~/Dropbox/Noise_genomics/Figures/ms_figures/human-BetaIslet-alt_data-allLM.png",
...
ggsave(tc_cpg,
       filename="~/Dropbox/Noise_genomics/Figures/ms_figures/human-BetaIslet-alt_data-boxplot_CpGislands-overdispersion.png",
...
ggsave(tc_cpgMe,
       filename="~/Dropbox/Noise_genomics/Figures/ms_figures/human-BetaIslet-alt_data-boxplot_CpGislands-mean.png",
       height=3.75, width=4.75, dpi=300)