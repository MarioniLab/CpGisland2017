...
source("~/Dropbox/R_sessions/Noise/genomic_noise_features_EPDnew-promoter.R")
...
mesc.vars <- colnames(genomic.features)[c(2:17)]
...
ggsave(univar.plot,
       filename="~/Dropbox/Noise_genomics/Figures/ms_figures/mESC_univariateLM-EPDnew_promoter.png",
...
write.table(mesc.rlm.res,
            file="~/Dropbox/Noise_genomics/Model_results/mouse_ESC_multivariateRLM-EPDnew_promoter.tsv",
...
ggsave(multivar.plot,
       filename="~/Dropbox/Noise_genomics/Figures/ms_figures/mESC_multiivariateLM-EPDnew_promoter.png",
       height=4.75, width=6.75, dpi=300)
...
ggsave(all.plot,
       filename="~/Dropbox/Noise_genomics/Figures/ms_figures/mESC_allLM-EPDnew_promoter.png",
...
ggsave(tc_cpg,
       filename="~/Dropbox/Noise_genomics/Figures/ms_figures/mESC_boxplot_CpGislands-overdispersion-EPDnew_promoter.png",
...
ggsave(tc_cpgMe,
       filename="~/Dropbox/Noise_genomics/Figures/ms_figures/mESC_boxplot_CpGislands-mean-EPDnew_promoter.png",
       height=3.75, width=4.75, dpi=300)
