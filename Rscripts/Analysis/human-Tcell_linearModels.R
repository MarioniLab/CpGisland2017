...
source("~/Dropbox/R_sessions/Noise/human_Tcell_genomic_noise_features.R")
...
tcell.var.names <- tcell.var.names[!grepl(tcell.var.names, pattern="(NMI)|(CGI_SIZE)|(cpg_)|(CGI)|(GENE)")]
...
ggsave(univar.plot,
       filename="~/Dropbox/Noise_genomics/Figures/ms_figures/human-Tcell_univariateLM.png",
...
ggsave(multivar.plot,
       filename="~/Dropbox/Noise_genomics/Figures/ms_figures/human-Tcell_multiivariateLM.png",
       height=4.75, width=6.75, dpi=300)
...
ggsave(all.plot,
       filename="~/Dropbox/Noise_genomics/Figures/ms_figures/human-Tcell_allLM.png",
...
ggsave(tc_cpg,
       filename="~/Dropbox/Noise_genomics/Figures/ms_figures/human-Tcell_boxplot_CpGislands-overdispersion.png",
...
ggsave(tc_cpgMe,
       filename="~/Dropbox/Noise_genomics/Figures/ms_figures/human-Tcell_boxplot_CpGislands-mean.png",
       height=3.75, width=4.75, dpi=300)