...
write.table(mesc.rlm.df,
            file="~/Dropbox/Noise_genomics/Model_results/Grun_serum-mouse_ESC_CGI-univariateRLM.tsv",
...
ggsave(cpg.plot,
       filename="~/Dropbox/Noise_genomics/Figures/ms_figures/Grun_serum-mESC_CGI-univariateLM.png",
...
write.table(mesc.rlm.res,
            file="~/Dropbox/Noise_genomics/Model_results/Grun_serum-mouse_ESC_CGI-multivariateRLM.tsv",
            quote=FALSE, row.names=FALSE, sep="\t")
...
ggsave(all.plot,
       filename="~/Dropbox/Noise_genomics/Figures/ms_figures/Grun_serum-mESC_CGI-allLM.png",
