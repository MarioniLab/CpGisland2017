# sans developmental genes - remove genes associated with developmental processes.
# these are human genes from MSigDB, need to map to mouse homologs
...
# get the ESC up-regulated genes from J1 mESC
source("~/Dropbox/src/CpGisland2017/Rscripts/Analysis/J1_mESC_DE.R")
...
write.table(mesc.rlm.df,
            file="~/Dropbox/Noise_genomics/Model_results/mouse_ESC_CGI-univariateRLM-sansESCDevel.tsv",
...
ggsave(cpg.plot,
       filename="~/Dropbox/Noise_genomics/Figures/ms_figures/mESC_CGI-univariateLM-sansESCDevel.png",
...
write.table(mesc.rlm.res,
            file="~/Dropbox/Noise_genomics/Model_results/mouse_ESC_CGI-multivariateRLM-sansESCDevel.tsv",
            quote=FALSE, row.names=FALSE, sep="\t")
...
ggsave(all.plot,
       filename="~/Dropbox/Noise_genomics/Figures/ms_figures/mESC_CGI-allLM-sansESCDevel.png",
