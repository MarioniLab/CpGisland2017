...
panc.vars <- panc.vars[grepl(panc.vars, pattern="(CGI_SIZE.kb)|(SP1)")]
...
write.table(panc.rlm.df,
            file="~/Dropbox/Noise_genomics/Model_results/human_AlphaIslet_CGI-alt_data-univariateRLM.tsv",
...
ggsave(cpg.plot,
       filename="~/Dropbox/Noise_genomics/Figures/ms_figures/human-AlphaIslet_CGI-alt_data-univariateLM.png",
...
write.table(panc.rlm.res,
            file="~/Dropbox/Noise_genomics/Model_results/human_AlphaIslet_CGI-alt_data-multivariateRLM.tsv",
            sep="\t", quote=FALSE, row.names=FALSE)
...
ggsave(cpg.plot,
       filename="~/Dropbox/Noise_genomics/Figures/ms_figures/human-AlphaIslet_CGI-alt_data-multiivariateLM.png",
       height=5.25, width=11.75, dpi=300)
...
ggsave(all.plot,
       filename="~/Dropbox/Noise_genomics/Figures/ms_figures/human-AlphaIslet_CGI-alt_data-allLM.png",
