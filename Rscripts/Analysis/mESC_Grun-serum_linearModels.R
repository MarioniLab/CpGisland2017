...
source("~/Dropbox/R_sessions/Noise/Grun_mESC_serum_genomic_noise_features.R")
...
ggsave(univar.plot,
       filename="~/Dropbox/Noise_genomics/Figures/ms_figures/Grun_serum-mESC_univariateLM.png",
...
write.table(mesc.rlm.res,
            file="~/Dropbox/Noise_genomics/Model_results/Grun_serum-mouse_ESC_multivariateRLM.tsv",
...
ggsave(multivar.plot,
       filename="~/Dropbox/Noise_genomics/Figures/ms_figures/Grun_serum-mESC_multiivariateLM.png",
       height=4.75, width=6.75, dpi=300)
...
ggsave(all.plot,
       filename="~/Dropbox/Noise_genomics/Figures/ms_figures/Grun_serum-mESC_allLM.png",
...
tc_cpg <- ggplot(mesc.match, aes(x=CpGisland, y=Residual.CV2, fill=CpGisland)) + 
  theme_mike() + 
...
ggsave(tc_cpg,
       filename="~/Dropbox/Noise_genomics/Figures/ms_figures/Grun_serum-mESC_boxplot_CpGislands-overdispersion.png",
       height=4.75, width=4.75, dpi=300)

tc_cpgMe <- ggplot(mesc.match, aes(x=CpGisland, y=Mean, fill=CpGisland)) + 
  theme_mike() + 
  # geom_jitter(position=position_jitterdodge(jitter.height=0,
  #                                           jitter.width=1.5),
  #             alpha=0.7) +
...
ggsave(tc_cpgMe,
       filename="~/Dropbox/Noise_genomics/Figures/ms_figures/Grun_serum-mESC_boxplot_CpGislands-mean.png",
       height=4.75, width=4.75, dpi=300)
