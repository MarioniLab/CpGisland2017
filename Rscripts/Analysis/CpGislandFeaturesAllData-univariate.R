...
# read in mouse data
mouse.esc <- read.table("~/Dropbox/Noise_genomics/Model_results/mouse_ESC_CGI-univariateRLM.tsv",
                        h=TRUE, sep="\t", stringsAsFactors=FALSE)

mouse.tcell <- read.table("~/Dropbox/Noise_genomics/Model_results/mouse_Tcell_CGI-univariateRLM.tsv",
                          h=TRUE, sep="\t", stringsAsFactors=FALSE)
...
# read in human data
human.alpha <- read.table("~/Dropbox/Noise_genomics/Model_results/human_AlphaIslet_CGI-univariateRLM.tsv",
                          h=TRUE, sep="\t", stringsAsFactors=FALSE)

human.beta <- read.table("~/Dropbox/Noise_genomics/Model_results/human_BetaIslet_CGI-univariateRLM.tsv",
                         h=TRUE, sep="\t", stringsAsFactors=FALSE)

human.esc <- read.table("~/Dropbox/Noise_genomics/Model_results/human_ESC_CGI-univariateRLM.tsv",
                        h=TRUE, sep="\t", stringsAsFactors=FALSE)
